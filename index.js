 ...
 * brainfudge interpreter
 */
var brainfudge = module.exports = {
    _callback   : null,     // callback reference
    _stack      : [],       // function stack
    _input      : '',       // last entered input
    _error      : null,     // last known error
    data        : [ 0 ],    // data store
    source      : '',       // brainfudge source code
    pointer     : 0,        // pointer to position in data store
    cursor      : 0,        // pointer to position in source
    exec        : exec,     // executes brainfudge source
    output      : ''        // output so far
};

_step = _step.bind(brainfudge); // bind step to the brainfudge singleton
_incoming = _incoming.bind(brainfudge); // bind step to the brainfudge singleton